<x-layouts.public title="Cek status laporan">
    <section class="min-h-[75vh] bg-[#F7F9FC] py-8 sm:py-14 lg:py-18">
        <div class="public-container max-w-md lg:max-w-lg">
            <div class="text-center">
                ...
                <h1 class="mt-2 text-2xl sm:text-3xl font-bold tracking-tight text-[#0B2342]">Cek status laporan</h1>
                <p class="mt-1.5 text-xs sm:text-sm text-[#64748B] leading-relaxed">Unggah QR akses untuk masuk cepat, atau gunakan kode laporan dan PIN.</p>
            </div>

            <form id="tracking-form" action="{{ route('reports.track.show') }}" method="POST" class="mt-8 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm sm:p-8 lg:p-9">
                @csrf
                ...
                <div>
                    <label class="form-label text-xs sm:text-sm font-semibold text-[#0B2342]" for="tracking_code">Kode laporan <span class="text-[#DC4C4C]">*</span></label>
                    <input
                ...
                <div class="mt-5">
                    <label class="form-label text-xs sm:text-sm font-semibold text-[#0B2342]" for="tracking_pin">PIN 6 digit <span class="text-[#DC4C4C]">*</span></label>
                    <input
                ...
                <button class="button-primary mt-6 w-full text-sm sm:text-base font-semibold h-12 rounded-xl bg-[#2563EB] text-white hover:bg-[#1D4ED8] transition-colors" type="submit">
                    <span>Cek status</span>
                </button>

                <div class="mt-5 rounded-xl bg-blue-50/70 border border-blue-100 p-3.5 text-center text-xs leading-relaxed text-[#0B2342]">
