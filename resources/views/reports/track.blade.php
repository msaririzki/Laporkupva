                ...
                <div class="grid lg:grid-cols-2">
                    <div class="p-5 sm:p-7 lg:p-8">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                <h2 class="text-base font-bold text-[#0B2342]">Gunakan gambar QR</h2>
                                <p class="mt-0.5 text-xs leading-5 text-slate-500">Cara tercepat jika Anda menyimpan gambar akses.</p>
                            </div>
                        </div>

                        <label class="relative mt-6 flex min-h-36 cursor-pointer flex-col items-center justify-center overflow-hidden rounded-2xl border border-dashed border-slate-300 bg-slate-50 px-5 py-6 text-center transition hover:border-[#2563EB] hover:bg-blue-50/50 focus-within:border-[#2563EB] focus-within:ring-4 focus-within:ring-blue-100" for="qr_access_image">
                            ...
                            <span class="mt-3 text-sm font-semibold text-[#0B2342]">Pilih gambar dari perangkat</span>
                            <span class="mt-1 text-xs text-slate-500">PNG, JPG, atau WebP · maksimal 8 MB</span>
                            <input class="absolute inset-0 size-full cursor-pointer opacity-0" id="qr_access_image" type="file" accept="image/png,image/jpeg,image/webp" data-qr-upload>
                        </label>
                        <p class="mt-3 text-xs leading-5 text-slate-500">Gambar hanya dibaca di perangkat ini dan tidak diunggah.</p>
